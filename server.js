...
app.prepare().then(() => {
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('createGame', (config) => {
            ...
            const allQuestions = parseQuestions(path.join(process.cwd(), 'Kahoot - Avaliação Diagnóstica.xlsx'));
            if (gameState.config.mode === 'quatro') {
                gameState.questions = allQuestions.fourOptions;
            } else if (gameState.config.mode === 'duas') {
                gameState.questions = allQuestions.twoOptions;
            } else {
                gameState.questions = allQuestions.combined;
            }
